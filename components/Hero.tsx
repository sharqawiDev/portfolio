...
import { FiGithub, FiLinkedin, FiMail, FiMapPin, FiBriefcase, FiFileText } from 'react-icons/fi';
    ...
    <section id="about" className="min-h-screen flex items-center justify-center px-4 py-20">
      <div className="max-w-5xl w-full">
        <div className="flex flex-col md:flex-row items-center gap-12">
          {/* Profile Image */}
          <div className="animate-fadeInUp flex-shrink-0">
          ...
          {/* Content */}
          <div className="animate-fadeInUp delay-100 flex-1">
            {/* Greeting */}
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 max-w-3xl mb-8 leading-relaxed">
            Software Engineer with <span className="font-semibold text-gray-800 dark:text-gray-200">6+ years of experience</span> building
            user-centric interfaces with <span className="font-semibold text-gray-800 dark:text-gray-200">React, React Native, and TypeScript</span>.
            Proven expertise in fintech and AI/compliance platforms, with a strong focus on testing, code quality, and performance optimization.
            Experienced in collaborative startup environments, delivering scalable solutions while staying current with emerging technologies.
          </p>
